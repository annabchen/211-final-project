...
public class PuzzleRoom2 implements Screen {
    ...
    LinkedList<Rectangle> exited;
    LinkedList<Rectangle> in;
    LinkedList<Rectangle> notEntered;
    float worldWidth;
    float worldHeight;
    ...
    private void logic() {
        ...
        doorLeftSprite.setX(worldWidth-tileWidth/2);
        doorLeftSprite.setY(worldHeight - tileWidth/2);
        ...
        doorTopSprite.setX(worldWidth-tileWidth/2);
        doorTopSprite.setY(tileWidth/2);
        ...
        doorRightSprite.setY(2.5f*tileWidth);
